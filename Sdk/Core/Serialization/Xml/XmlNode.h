 ...
 * дочерние узлы, то текст отображен не будет.
 ...
 * XmlNode::getChildrenBeginIterator() и XmlNode::getChildrenEndIterator().
 *
...
public:
    ...
    /**
     * @brief Устанавливает текстовые данные для элемента. Не будет использоваться, если у элемента есть дочерние узлы.
     * @param data Строка
     */
